...
root.iconbitmap("Fotos InterfacesGraficas\icono-de-reloj-para-sitios-web-y-aplicaciones-imagen-fondo-turquesa-ilustración-vectorial-línea-plana-eps-179972961.ico")
...
def Menu_Hamburguesa():
    ...
    miButton = Button(menu,command=lambda:[Inicio(),menu.destroy()],text=" I N I C I O",width=42,height=2,fg="white",border=0,bg="#12c4c0",activeforeground="#262626",activebackground="#0f9d9a",cursor="hand2")
    miButton.place(x=0,y=80)
    miButton1 = Button(menu,command=lambda:[Alarma(),menu.destroy()],text=" A L A R M A",width=42,height=2,fg="white",border=0,bg="#12c4c0",activeforeground="#262626",activebackground="#0f9d9a",cursor="hand2") 
    miButton1.place(x=0,y=117)
    miButton2 = Button(menu,command=lambda:[Cronometro(),menu.destroy()],text=" C R O N Ó M E T R O",width=42,height=2,fg="white",border=0,bg="#12c4c0",activeforeground="#262626",activebackground="#0f9d9a",cursor="hand2") 
    miButton2.place(x=0,y=154)
    miButton3 = Button(menu,command=lambda:[Temporizador(),menu.destroy()],text=" T E M P O R I Z A D O R",width=42,height=2,fg="white",border=0,bg="#12c4c0",activeforeground="#262626",activebackground="#0f9d9a",cursor="hand2") 
    ...
    CloseIMG = PhotoImage(file="Fotos InterfacesGraficas\close.png")
    Button(menu,image=CloseIMG,border=0,command=lambda:menu.destroy(),bg="#12c4c0",activebackground="#12c4c0",cursor="hand2").place(x=5,y=10)
...
def Inicio():
    ...
    LugarLabel = Label(FrameInicio,text="Costa Rica, San José",fg="#12c4c0",font=("Helvetica",10,"bold"),bg="white")
...
def Cronometro():
    ...
    PlayIMG = PhotoImage(file="Fotos InterfacesGraficas\BotonPlay.png")
    PausaIMG = PhotoImage(file="Fotos InterfacesGraficas\BotonPausar.png")
    ReinicioIMG = PhotoImage(file="Fotos InterfacesGraficas\ReiniciarBoton.png")
    ...
    if not CorriendoCrono:
        ...
        BotonPausaPlayCron = Button(FrameCrono,command=PlayCrono,image=PlayIMG,border=0,bg="white",activebackground="white",cursor="hand2")
        BotonPausaPlayCron.place(x=287,y=250)
        BotonReiniciarCron = Button(FrameCrono,command=ReiniciarCrono,image=ReinicioIMG,border=0,bg="white",activebackground="white",cursor="hand2")
...
def Alarma():
    ...
    ArribaIMG = PhotoImage(file="Fotos InterfacesGraficas\Arriba.png")
    AgregarIMG = PhotoImage(file="Fotos InterfacesGraficas\Agregar.png")
    RelojIMG = PhotoImage(file="Fotos InterfacesGraficas\Reloj.png")
    AbajoIMG = PhotoImage(file="Fotos InterfacesGraficas\Abajo.png") 
    try:
        if not AlarmaGuardada:
            FrameAlarma.destroy()
    except AttributeError:
    ...
    if not AlarmaGuardada:
        ...
        CrearAlarmaButton = Button(FrameAlarma,image=AgregarIMG,command=CrearAlarma,border=0,bg="white",activebackground="white",cursor="hand2")
        CrearAlarmaButton.place(x=700,y=420)

        RelojIMGLabel=Label(FrameAlarma,image=RelojIMG,bg="white")
        RelojIMGLabel.place(x=284,y=25)

        LabelAlarma = Label(FrameAlarma,text="No tienes ninguna alarma.",font=("Helvetiva",20),bg="white",fg="#12c4c0")
...
def CrearAlarma():
    ...
    FrameCrearAlarma = Frame(FrameAlarma,width=500,height=300,bg="white",highlightbackground="grey",highlightthickness=3)
    ...
    Button(FrameCrearAlarma,command=lambda:AlarmaArriba("HoraVar"),image=ArribaIMG,bg="white",activebackground="white",border=0).place(x=80,y=20)
    Button(FrameCrearAlarma,command=lambda:AlarmaArriba("MinutosVar"),image=ArribaIMG,bg="white",activebackground="white",border=0).place(x=220,y=20)
    Button(FrameCrearAlarma,command=lambda:AlarmaArriba("AMPMVar"),image=ArribaIMG,bg="white",activebackground="white",border=0).place(x=360,y=20)
    Button(FrameCrearAlarma,command=lambda:AlarmaAbajo("HoraVar"),image=AbajoIMG,bg="white",activebackground="white",border=0).place(x=80,y=120)
    Button(FrameCrearAlarma,command=lambda:AlarmaAbajo("MinutosVar"),image=AbajoIMG,bg="white",activebackground="white",border=0).place(x=220,y=120)
    Button(FrameCrearAlarma,command=lambda:AlarmaAbajo("AMPMVar"),image=AbajoIMG,bg="white",activebackground="white",border=0).place(x=360,y=120)
    Guardar = Button(FrameCrearAlarma,command=GuardarAlarma,text="Guardar",font=("Helvetica",20),justify="center",bg="#12c4c0",fg="white",border=0,cursor="hand2")
    Guardar.place(x=50,y=230)
    Cancelar = Button(FrameCrearAlarma,command=lambda:[FrameCrearAlarma.destroy(),CrearAlarmaButton.config(state="normal")],text="Cancelar",font=("Helvetica",20),justify="center",fg="#12c4c0",border=0,cursor="hand2")
    Cancelar.place(x=310,y=230)
    Guardar.config(state="disabled")
    Lunes = Button(FrameCrearAlarma,command=lambda:Días("Lunes"),text="L",font=("Helvetica",15),bg="white",border=0)
    Lunes.place(x=55,y=180)
    Martes = Button(FrameCrearAlarma,command=lambda:Días("Martes"),text="M",font=("Helvetica",15),bg="white",border=0)
    Martes.place(x=115,y=180)
    Miercoles = Button(FrameCrearAlarma,command=lambda:Días("Miercoles"),text="X",font=("Helvetica",15),bg="white",border=0)
    Miercoles.place(x=175,y=180)
    Jueves = Button(FrameCrearAlarma,command=lambda:Días("Jueves"),text="J",font=("Helvetica",15),bg="white",border=0)
    Jueves.place(x=235,y=180)
    Viernes = Button(FrameCrearAlarma,command=lambda:Días("Viernes"),text="V",font=("Helvetica",15),bg="white",border=0)
    Viernes.place(x=295,y=180)
    Sabado = Button(FrameCrearAlarma,command=lambda:Días("Sabado"),text="S",font=("Helvetica",15),bg="white",border=0)
    Sabado.place(x=355,y=180)
    Domingo = Button(FrameCrearAlarma,command=lambda:Días("Domingo"),text="D",font=("Helvetica",15),bg="white",border=0)
...
def GuardarAlarma():
    ...
    AlarmaGuardada = True
    CerrarIMG = PhotoImage(file="Fotos InterfacesGraficas\Cerrar.png")
    def EliminarAlarma():
        global AlarmaGuardada,VarEliminarAlarma
        AlarmaGuardada = False
        VarEliminarAlarma = True
        Alarma()
    EliminarAlarmaButton = Button(FrameAlarma,command=EliminarAlarma,image=CerrarIMG,border=0,bg="white",cursor="hand2",activebackground="white")
    EliminarAlarmaButton.place(x=730,y=10)
    FrameCrearAlarma.destroy()
    CrearAlarmaButton.place_forget()
    RelojIMGLabel.place(x=284,y=225)
    LabelAlarma = Label(FrameAlarma,text="Tu alarma sonará\n muy pronto...",font=("Helvetica",50,"bold"),bg="white",fg="#12c4c0")
    ...
    if ((time.strftime("%w") == día and
        ...
        int(HoraVar) == 12 and
        AMPMVar == "PM")):
        AlarmaMomentoSonar.config(text=f"Alarma programada para {díaEsp} {ProximaFecha} {MesProximaFecha} a las {HoraVar}:{MinutosVar} {AMPMVar}")
        ...
        if ((time.strftime("%w") == día and
            ...
            AlarmaMomentoSonar.config(text=f"Alarma programada para el {díaEsp} {FechaDía} {MesFecha} a las {HoraVar}:{MinutosVar} {AMPMVar}")
            AlarmaMomentoSonar.place(x=100,y=325)  
            AlarmaSonar(3)
...
def AlarmaSonar(arg):
    ...
    if not VarEliminarAlarma:
        ...
        if Sonar:
            ...
            FrameAlarmaSonando = Frame(FrameAlarma,width=400,height=300,bg="white",highlightbackground="grey",highlightthickness=3)
            ...
            Button(FrameAlarmaSonando,text="C A N C E L A R",font=("Helvetica",15,"bold"),bg="#12c4c0",fg="white",border=0,cursor="hand2",
...
def Temporizador():
    ...
    if not CorriendoTemp:
        ...
        Button(FrameTemp,command=lambda:TempAbajo("HorasTemp"),image=AbajoIMG,bg="white",activebackground="white",border=0).place(x=148,y=240)
        Button(FrameTemp,command=lambda:TempAbajo("MinutosTemp"),image=AbajoIMG,bg="white",activebackground="white",border=0).place(x=332,y=240)
        Button(FrameTemp,command=lambda:TempAbajo("SegundosTemp"),image=AbajoIMG,bg="white",activebackground="white",border=0).place(x=516,y=240)
        IniciarBoton = Button(FrameTemp,command=PlayTemp,font=("Helvetica",20,"bold"),text="Iniciar",justify="center",fg="white",bg="#12c4c0",border=0,cursor="hand2",width=20,state="disabled")
